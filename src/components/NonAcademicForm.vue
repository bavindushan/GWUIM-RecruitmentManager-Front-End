...
export default {
  ...
  methods: {
    // O/L Results
    addOLRow() {
      this.olResults.push({ ExamYear: "", Subject: "", Grade: "" });
    },
    removeOLRow(index) {
      this.olResults.splice(index, 1);
    },
    async saveOLResults() {
      try {
    ...
    // A/L Results
    addALRow() {
      this.alResults.push({ ExamYear: "", Subject: "", Grade: "" });
    },
    removeALRow(index) {
      this.alResults.splice(index, 1);
    },
    async saveALResults() {
    ...
    async saveUniversityEducation() {
      ...
      Swal.fire(
        "Saved!",
        "University Education saved successfully.",
        "success"
      );
    },
    ...
    async saveProfessionalQualifications() {
      ...
      Swal.fire(
        "Saved!",
        "Professional Qualifications saved successfully.",
        "success"
      );
    },
    /********** Employment Records **********/
    ...
    // Experience
    addExpRow() {
      this.experienceDetails.push({ Description: "" });
    },
    removeExpRow(index) {
    ...
    removeSQRow(index) {
      this.specialQualifications.splice(index, 1);
    },
    async saveSpecialQualifications() {
      ...
      Swal.fire(
        "Saved!",
        "Special Qualifications saved successfully.",
        "success"
      );
    },
    /********** References **********/
    ...
    async deleteAllApplicationData() {
      ...
      try {
        await api.delete(
          `/api/applications/delete-all-na/${parseInt(this.applicationId)}`
        );
