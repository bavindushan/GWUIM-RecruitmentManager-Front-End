<template>
  <div class="container py-4">
    ...
    <div class="card border-0 shadow-sm rounded-4 mb-4">
      <div class="card-body p-4 p-md-5">
        <h5 class="fw-bold mb-4">
          <i class="bi bi-book me-2"></i> Secondary Education
        </h5>
        ...
        <table class="table table-bordered table-striped mb-3">
          ...
          <tbody>
            <tr v-for="(sec, idx) in secondaryEducations" :key="idx">
              ...
              <td>
                <input
                  v-model.number="sec.ToYear"
                  type="number"
                  class="form-control"
                />
              </td>
              <td>
                <input v-model="sec.ExaminationPassed" class="form-control" />
              </td>
              <td>
                <input
                  v-model.number="sec.PassedYear"
                  type="number"
                  class="form-control"
                />
              </td>
            ...
            <tr v-if="secondaryEducations.length === 0">
              <td colspan="6" class="text-center text-muted">
                No secondary education added yet.
              </td>
            </tr>
          </tbody>
        </table>
    ...
    <div class="card border-0 shadow-sm rounded-4 mb-4">
      <div class="card-body p-4 p-md-5">
        <h5 class="fw-bold mb-4">
          <i class="bi bi-mortarboard me-2"></i> Higher Education / University
          Education
        </h5>
        ...
        <table class="table table-bordered table-striped mb-3">
          ...
          <tbody>
            <tr v-for="(edu, index) in universityEducations" :key="index">
              <td>
                <input v-model="edu.DegreeOrDiploma" class="form-control" />
              </td>
              <td><input v-model="edu.Institute" class="form-control" /></td>
              <td>
                <input
                  v-model.number="edu.FromYear"
                  type="number"
                  class="form-control"
                />
              </td>
              ...
              <td>
                <input
                  v-model.number="edu.YearObtained"
                  type="number"
                  class="form-control"
                />
              </td>
            ...
            <tr v-if="universityEducations.length === 0">
              <td colspan="8" class="text-center text-muted">
                No university education added yet.
              </td>
            </tr>
          </tbody>
        </table>
    ...
    <div class="card border-0 shadow-sm rounded-4 mb-4">
      <div class="card-body p-4 p-md-5">
        ...
        <select v-model="selectedUniversityId" class="form-select mb-3">
          ...
          <option
            v-for="uni in universityEducations"
            :key="uni.UE_ID"
            :value="uni.UE_ID"
          >
      ...
      <div class="card-body p-4 p-md-5">
        ...
        <table class="table table-bordered table-striped">
          ...
          <tbody>
            <tr v-for="(pq, index) in professionalQualifications" :key="index">
              ...
              <td>
                <input v-model="pq.QualificationName" class="form-control" />
              </td>
              <td>
                <input
                  v-model.number="pq.FromYear"
                  type="number"
                  class="form-control"
                />
              </td>
              <td>
                <input
                  v-model.number="pq.ToYear"
                  type="number"
                  class="form-control"
                />
              </td>
              <td>
                <input v-model="pq.ResultOrExamPassed" class="form-control" />
              </td>
              <td class="text-center">
                <button
                  class="btn btn-danger btn-sm"
                  @click="removePQRow(index)"
                >
                  <i class="bi bi-trash"></i>
                </button>
              </td>
        ...
        <div class="d-flex justify-content-between">
          ...
          <button
            ...
            @click="saveProfessionalQualifications"
          >
    ...
    <div class="card border-0 shadow-sm rounded-4 mb-4">
      <div class="card-body p-4 p-md-5">
        <h5 class="fw-bold mb-4">
          <i class="bi bi-stars me-2"></i> Special Qualifications /
          Extra-curricular
        </h5>
        ...
        <div class="d-flex justify-content-between">
          <button class="btn btn-success btn-sm" @click="addSQRow">
    ...
    <div class="card border-0 shadow-sm rounded-4 mb-4">
      <div class="card-body p-4 p-md-5">
        <h5 class="fw-bold mb-4">
          <i class="bi bi-translate me-2"></i> Languages Proficiency
        </h5>

        <div
          v-for="(lang, index) in languagesProficiency"
          :key="index"
          class="row g-2 mb-2"
        >
          <div class="col-md-2">
        ...
        <div class="d-flex justify-content-between">
          <button class="btn btn-success btn-sm" @click="addLangRow">
    ...
    <div class="card border-0 shadow-sm rounded-4 mb-4">
      <div class="card-body p-4 p-md-5">
        ...
        <table class="table table-bordered table-striped">
          ...
          <tbody>
            <tr v-for="(emp, index) in employmentRecords" :key="index">
              ...
              <td>
                <input
                  v-model="emp.FromDate"
                  type="date"
                  class="form-control"
                />
              </td>
              <td>
                <input v-model="emp.ToDate" type="date" class="form-control" />
              </td>
              <td>
                <input
                  v-model.number="emp.LastSalary"
                  type="number"
                  class="form-control"
                />
              </td>
        ...
        <div class="d-flex justify-content-between">
          <button class="btn btn-success btn-sm" @click="addEmpRow">
    ...
    <div class="card border-0 shadow-sm rounded-4 mb-4">
      <div class="card-body p-4 p-md-5">
        <h5 class="fw-bold mb-4">
          <i class="bi bi-journal-text me-2"></i> Experiences Related to the Job
        </h5>

        <div
          v-for="(exp, index) in experienceDescription"
          :key="index"
        ...
        <div class="d-flex justify-content-between">
          <button class="btn btn-success btn-sm" @click="addExpRow">
    ...
    <div class="card border-0 shadow-sm rounded-4 mb-4">
      <div class="card-body p-4 p-md-5">
        <h5 class="fw-bold mb-4">
          <i class="bi bi-file-earmark-text me-2"></i> Research & Publications
        </h5>

        <div
          v-for="(pub, index) in researchPublications"
          :key="index"
          class="d-flex gap-2 mb-2"
        >
          <input
        ...
        <div class="d-flex justify-content-between">
          <button class="btn btn-success btn-sm" @click="addPubRow">
    ...
    <div class="card border-0 shadow-sm rounded-4 mb-4">
      <div class="card-body p-4 p-md-5">
        ...
        >
          <div class="col-md-4">
            <input v-model="ref.Name" class="form-control" placeholder="Name" />
          </div>
          <div class="col-md-4">
            <input
              v-model="ref.Designation"
              class="form-control"
        ...
        <div class="d-flex justify-content-between">
          <button class="btn btn-success btn-sm" @click="addRefRow">
    ...
    <div class="card border-0 shadow-sm rounded-4 mb-4">
      <div class="card-body p-4 p-md-5">
        ...
        <textarea
          v-model="additionalInfo.content"
    ...
    <!-- 13. Degree Transcript Upload -->
    <div class="card border-0 shadow-sm rounded-4 mb-4">
      <div class="card-body p-4 p-md-5">
        <h5 class="fw-bold mb-4">
          <i class="bi bi-file-earmark-arrow-up me-2"></i> Degree Transcript
          Upload
        </h5>
        ...
        <div v-if="transcriptFilePath" class="mb-3">
          <p>
            Uploaded File:
            <a :href="transcriptFilePath" target="_blank">{{
              transcriptFilePath
            }}</a>
          </p>

          <div class="d-flex gap-2">
            <button class="btn btn-success btn-sm" @click="submitTranscript">
              <i class="bi bi-upload me-1"></i> Submit Transcript
            </button>
            <button class="btn btn-danger btn-sm" @click="deleteTranscript">
              <i class="bi bi-trash me-1"></i> Delete Transcript
            </button>
          </div>
        </div>
      </div>
    ...
    <div class="card border-0 shadow-sm rounded-4 mb-4">
      <div class="card-body p-4 p-md-5">
        ...
        <div v-if="cvFilePath" class="mb-3">
          <p>
            Uploaded File:
            <a :href="cvFilePath" target="_blank">{{ cvFilePath }}</a>
          </p>
          <div class="d-flex gap-2">
            <button class="btn btn-success btn-sm" @click="submitCV">
  ...
  methods: {
    ...
    async saveSecondaryEducation() {
      try {
        if (!this.applicationId) {
          return Swal.fire(
            "Missing",
            "Application ID is required to save secondary education.",
            "warning"
          );
        }
    ...
    async saveUniversityEducation() {
      try {
        if (!this.universityEducations.length) {
          return Swal.fire(
            "No Data",
            "Please add at least one university education.",
            "warning"
          );
        }
        ...
        for (const edu of this.universityEducations) {
          if (
            ...
            return Swal.fire(
              "Incomplete",
              "Please fill in all required fields for all university education rows.",
              "warning"
            );
          }
        }
        ...
        Swal.fire(
          "Saved",
          "All university education saved successfully.",
          "success"
        );
    ...
    async fetchUniversityEducations() {
      try {
        const response = await api.get(
          `/api/applications/university-educations/${this.jobId}`
        );
    ...
    async saveProfessionalQualifications() {
      try {
        ...
        Swal.fire(
          "Error",
          "Failed to save professional qualifications.",
          "error"
        );
      }
    },
    ...
    addLangRow() {
      this.languagesProficiency.push({
        Language: "",
        CanSpeak: "",
        CanRead: "",
        CanWrite: "",
    ...
    async saveAdditionalInfo() {
      try {
        if (!this.applicationId)
          return Swal.fire("Missing", "Application ID is required.", "warning");
    ...
    async submitCV() {
      ...
      if (!this.applicationId) {
        return Swal.fire(
          "Warning",
          "Application ID missing — CV will not be attached.",
          "warning"
        );
      }
      ...
      try {
        ...
        if (!fileUrl) {
          return Swal.fire(
            "Error",
            "Upload failed: server did not return file URL.",
            "error"
          );
        }
        ...
        Swal.fire(
          "Uploaded",
          "CV uploaded and attached successfully.",
          "success"
        );
      } catch (err) {
        console.error(err);
    ...
    handleTranscriptUpload(e) {
        ...
        if (file) {
            ...
            this.transcriptFilePath = URL.createObjectURL(file);
        }
    },

    async submitTranscript() {
        if (!this.transcriptFile) {
            return Swal.fire("Warning", "Please select a transcript file first.", "warning");
        }

        if (!this.applicationId) {
            return Swal.fire("Warning", "Application ID missing — transcript will not be attached.", "warning");
        }
        ...
        try {
            ...
            const fileUrl = res?.data?.data?.fileUrl || null;
            if (!fileUrl) {
                return Swal.fire("Error", "Upload failed: no file URL returned.", "error");
            }

            this.transcriptFilePath = fileUrl;

            // Save file record in attachments
            await api.post("/api/applications/attachments", {
                applicationId: Number(this.applicationId),
            ...
            Swal.fire("Uploaded", "Degree transcript uploaded successfully.", "success");

        } catch (err) {
            console.error(err);
            Swal.fire("Error", "Error uploading degree transcript.", "error");
        }
    },
    ...
    async deleteTranscript() {
        ...
        try {
            const filename = this.transcriptFilePath.split("/").pop();
            await api.delete(`/api/files/delete/${filename}`);

            this.transcriptFile = null;
            this.transcriptFilePath = "";

            Swal.fire("Deleted", "Degree transcript deleted successfully.", "success");
        } catch (err) {
            console.error(err);
            Swal.fire("Error", "Error deleting degree transcript.", "error");
        }
    },
    ...
    async deleteAllApplicationData() {
      if (!this.applicationId) {
        return Swal.fire(
          "Missing",
          "Application ID required to delete application data.",
          "warning"
        );
      }
      ...
      try {
        await api.delete(
          `/api/applications/delete-all-ac/${this.applicationId}`
        );
        ...
        Swal.fire(
          "Deleted!",
          "All application details have been deleted.",
          "success"
        );
      } catch (err) {
        console.error(err);
